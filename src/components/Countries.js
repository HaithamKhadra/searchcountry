            ...
            <div data-value={country.name} className="countries__card" key={i}>
              ...
              <Link to={`/details`}>
                <div
                  ...
                  onClick={onClick}
                  className="countries__brief-info"
                >
                  <h2 className="countries__name">{country.name}</h2>
                  <div>
                    <span className="countries__brief-infos">Population:</span>{" "}
                    {country.population.toLocaleString()}
                  </div>
                  <div>
                    <span className="countries__brief-infos">Region:</span>{" "}
                    {country.region}
                  </div>
                  <div>
                    <span className="countries__brief-infos">Capital:</span>{" "}
                    {country.capital}
                  </div>
                </div>
              </Link>
