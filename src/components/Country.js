...
const Country = ({ filtered, onClick, countries, link, btnClassName }) => {
  ...
  return (
    <section className="country-details">
      <Link to='/'>
        <Button iconClassName="bi bi-arrow-left" onClick={onClick} label='Back' btnClassName={btnClassName}/>
      </Link>
      ...
      <div className="country-details__container">
        ...
        <div className="country-details__description">
          ...
          <div className="country-details__box-1">
            ...
            <div><span className="country-details__infos">Native Name: </span>--TODO--</div>
            <div><span className="country-details__infos">Population: </span>{filtered[0].population.toLocaleString()}</div>
            <div><span className="country-details__infos">Region: </span>{filtered[0].region}</div>
            <div><span className="country-details__infos">Sub Region: </span>{filtered[0].subregion}</div>
            <div><span className="country-details__infos">Capital: </span>{filtered[0].capital}</div>
          </div>
          <div className="country-details__box-2">
            <div><span className="country-details__infos">Top Level Domain: </span>{filtered[0].topLevelDomain[0]}</div>
            {/* <div><span>Top Level Domain: </span>{filtered[0].topLevelDomain.join(' / ')}</div> */}
            <div><span className="country-details__infos">Currencies: </span>--TODO--</div>
            ...
            <div><span className="country-details__infos">Languages: </span>--TODO--</div>
            {/* <div>
              {
                bc.length > 0
